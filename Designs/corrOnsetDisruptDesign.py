...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.fractionProbeTrialsEdit = QtWidgets.QLineEdit(Form)
        self.fractionProbeTrialsEdit.setObjectName("fractionProbeTrialsEdit")
        self.gridLayout.addWidget(self.fractionProbeTrialsEdit, 12, 2, 1, 1)
        self.labelSp = QtWidgets.QLabel(Form)
        self.labelSp.setObjectName("labelSp")
        self.gridLayout.addWidget(self.labelSp, 11, 1, 1, 1)
        self.fractionSpRewardedEdit = QtWidgets.QLineEdit(Form)
        self.fractionSpRewardedEdit.setObjectName("fractionSpRewardedEdit")
        self.gridLayout.addWidget(self.fractionSpRewardedEdit, 12, 1, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_3.setText(_translate("Form", "8 Valve Correlated vs. Uncorrelated - Onset Disrupt"))
        ...
        self.label_12.setText(_translate("Form", "Fraction Probe Trials"))
        self.fractionProbeTrialsEdit.setText(_translate("Form", "0.1"))
        self.labelSp.setText(_translate("Form", "Fraction S+ Rewarded"))
        self.fractionSpRewardedEdit.setText(_translate("Form", "0.9"))
