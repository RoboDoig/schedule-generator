...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayout.addWidget(self.nControlTrialsEdit, 12, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.lickFractionEdit, 12, 0, 1, 1)
        self.label_9 = QtWidgets.QLabel(Form)
        self.label_9.setObjectName("label_9")
        self.gridLayout.addWidget(self.label_9, 8, 1, 1, 1)
        self.cycleLengthUpperEdit = QtWidgets.QLineEdit(Form)
        self.cycleLengthUpperEdit.setObjectName("cycleLengthUpperEdit")
        self.gridLayout.addWidget(self.cycleLengthUpperEdit, 9, 1, 1, 1)
        self.label_12 = QtWidgets.QLabel(Form)
        self.label_12.setObjectName("label_12")
        self.gridLayout.addWidget(self.label_12, 8, 0, 1, 1)
        self.cycleLengthLowerEdit = QtWidgets.QLineEdit(Form)
        self.cycleLengthLowerEdit.setObjectName("cycleLengthLowerEdit")
        self.gridLayout.addWidget(self.cycleLengthLowerEdit, 9, 0, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_9.setText(_translate("Form", "Cycle Length Upper Limit (ms)"))
        self.cycleLengthUpperEdit.setText(_translate("Form", "500"))
        self.label_12.setText(_translate("Form", "Cycle Length Lower Limit (ms)"))
        self.cycleLengthLowerEdit.setText(_translate("Form", "62"))
