...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.cameraFrEdit = QtWidgets.QLineEdit(Form)
        self.cameraFrEdit.setObjectName("cameraFrEdit")
        self.gridLayout.addWidget(self.cameraFrEdit, 12, 1, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_3.setText(_translate("Form", "8 Valve Correlated vs. Uncorrelated - Difficulty Switch - Camera Trigger"))
        ...
        self.label_13.setText(_translate("Form", "Valve Map Setup : 0 = Blank, 1 = Odour 1, 2 = Odour 2, 3 = Control Odour 1, 4 = Control Blank, 5 = Camera Channel"))
        self.onsetEdit.setText(_translate("Form", "1"))
        ...
        self.label_14.setText(_translate("Form", "Camera Frame Rate (Hz)"))
        self.cameraFrEdit.setText(_translate("Form", "50"))
